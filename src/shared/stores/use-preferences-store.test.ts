...
describe("usePreferencesStore", () => {
  ...
  describe("default values", () => {
    ...
    it("has 3 default alert thresholds", () => {
      ...
      expect(thresholds[0]).toEqual({ alert_type: "cpu", threshold_percent: 90, enabled: true });
      expect(thresholds[1]).toEqual({ alert_type: "memory", threshold_percent: 85, enabled: true });
      expect(thresholds[2]).toEqual({ alert_type: "disk", threshold_percent: 90, enabled: true });
    });
  });
