...
impl BumbleProfileDto {
    fn into_user_profile(self) -> UserProfile {
        UserProfile {
            id: self.id,
            site: DatingSite::Bumble,
...
pub struct BumbleMcpRepository {
    client: McpClient,
}

impl BumbleMcpRepository {
...
#[async_trait]
impl DatingProfileRepository for BumbleMcpRepository {
